		...
		<>
			<View style={WalletProcessLayout.processWrap}>
				<View style={WalletProcessLayout.iconCenterWrap}>
					<View style={WalletProcessLayout.iconWrap1}>
						<Image source={WhiteLockIcon} style={WalletProcessLayout.icon} />
					</View>
				...
				<View style={WalletProcessLayout.iconCenterWrap}>
					<View style={WalletProcessLayout.iconWrap}>
						<Image source={WhiteWalletIcon} style={WalletProcessLayout.icon} />
					</View>
