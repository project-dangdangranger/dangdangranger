        ...
        <>
            <CommonLayout>
                ...
                <View style={AgreeWalletLayout.buttonWrap}>
                    <TouchableOpacity activeOpacity={0.7} style={AgreeWalletLayout.widthWrap} onPress={() => navigation.navigate('Wallet')}>
                        <View style={AgreeWalletLayout.disAgreeButton}>
                            <Text style={AgreeWalletLayout.disAgreeButtonText}>아니요, 괜찮습니다.</Text>
                        </View>
                    </TouchableOpacity>
                    <TouchableOpacity activeOpacity={0.7} style={AgreeWalletLayout.widthWrap} onPress={() => navigation.navigate('MakeWallet2')}>
